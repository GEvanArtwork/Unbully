...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Animation")).getAnimationName() == "DragonRun" ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[k] = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[i];
        ++k;
    }
...
for (var i = 0, k = 0, l = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects2[i].getAnimationFrame() == 5 ) {
...
for (var i = 0, k = 0, l = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects2[i].getAnimationFrame() == 8 ) {
        isConditionTrue_1 = true;
        gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects2[k] = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects2[i];
        ++k;
    }
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Animation")).getAnimationName() == "DragonRun2" ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[k] = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[i];
        ++k;
    }
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Animation")).getAnimationName() == "DragonRun3" ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[k] = gdjs.evtsExt__Player__IsSteppingOnFloor.GDPlayerObjects1[i];
        ++k;
    }
