...
gdjs.evtsExt__InputValidation__RemoveNewLines.idToCallbackMap = new Map();
...
{
{runtimeScene.getScene().getVariables().get("__Sanitizer_tmpStr").setString(eventsFunctionContext.getArgument("text"));
}
}
...
let isConditionTrue_0 = false;
{
{eventsFunctionContext.returnValue = gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__Sanitizer_tmpStr"));}
}
